...
export const ProcessedNotaSection: React.FC<ProcessedNotaSectionProps> = ({
  ...
  return (
    <section id="section-nota-diproses" className="space-y-6">
      ...
      {/* Main Table & Filter Tools (Hanya muncul jika sudah ada data yang masuk / di-scan) */}
      {totalNotas > 0 && (
        <div
          id="table-nota-diproses-container"
          className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden space-y-4 p-5 sm:p-6"
        >
